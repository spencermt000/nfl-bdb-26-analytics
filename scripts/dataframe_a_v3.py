...
# IMPORTANT: Also standardize ball landing coordinates
print("\nStandardizing ball landing coordinates...")
going_left_mask = input_df['direction'] == 'GOING LEFT'
if going_left_mask.any():
    input_df.loc[going_left_mask, 'ball_land_x'] = 120 - input_df.loc[going_left_mask, 'ball_land_x']
    input_df.loc[going_left_mask, 'ball_land_y'] = 53.3 - input_df.loc[going_left_mask, 'ball_land_y']
    print(f"  ✓ Standardized ball_land_x and ball_land_y for {going_left_mask.sum():,} rows")
